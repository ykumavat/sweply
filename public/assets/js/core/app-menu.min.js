    ...
    r.app.menu = {
        ...
        change: function(e) {
            ...
            "vertical-menu" !== s && "vertical-menu-modern" !== s || this.toOverlayMenu(n.name, s), l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(n.name), r(".menu-toggle").removeClass("is-active")), "horizontal-menu" != s && this.drillDownMenu(n.name), "xl" == n.name && (r('body[data-open="hover"] .header-navbar .dropdown').on("mouseenter", function() {
                ...
                t && (e = r(o).height(), n = r(this).position().top, a = t.offset().left, i = t.width(), e - n - t.height() - 28 < 1 && (s = e - n - 170, r(this).find(".dropdown-menu").css({
                    ...
                    wheelPropagation: !1
                })), 0 <= a + i - (o.innerWidth - 16) && r(this).addClass("openLeft"))
        ...
        open: function() {
            this.transit(function() {
                l.removeClass("menu-hide menu-collapsed").addClass("menu-open"), this.hidden = !1, this.expanded = !0, l.hasClass("vertical-layout") && (r(".sidenav-overlay").removeClass("d-none").addClass("d-block"), r("body").css("overflow", "hidden"))
            }, function() {
                !r(".main-menu").hasClass("menu-native-scroll") && r(".main-menu").hasClass("menu-fixed") && (this.manualScroller.enable(), r(".main-menu-content").css("height", r(o).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight())), l.hasClass("vertical-layout") || (r(".sidenav-overlay").removeClass("d-block d-none"), r("body").css("overflow", "auto"))
            })
        },
        hide: function() {
            this.transit(function() {
                l.removeClass("menu-open menu-expanded").addClass("menu-hide"), this.hidden = !0, this.expanded = !1, l.hasClass("vertical-layout") && (r(".sidenav-overlay").removeClass("d-block").addClass("d-none"), r("body").css("overflow", "auto"))
            }, function() {
                !r(".main-menu").hasClass("menu-native-scroll") && r(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(), l.hasClass("vertical-layout") || (r(".sidenav-overlay").removeClass("d-block d-none"), r("body").css("overflow", "auto"))
            })
        },
        expand: function() {
        ...
        adjustSubmenu: function(e) {
            var n, a, i = e.children("ul:first"),
                s = i.clone(!0),
                t = (r(".main-menu-header").height(), e.position().top),
                o = d.height() - r(".header-navbar").height(),
                l = 0;
            i.height();
