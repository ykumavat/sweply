...
function show_tabs(id){
   /*  if(id == 'prev'){
        id =  $('.steps-counter-section ul li .active').attr('class').split(' ')[0].replace('step','');
    }
   
    alert(id); */
   // jQuery(".steps-counter-section ul li .active").removeClass('active');
   if(id == 'next' ){
