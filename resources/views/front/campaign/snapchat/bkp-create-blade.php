                    ...
                    <fieldset id="step-1">
                        <div class="twitter-step-section">
                            <div class="creadte-ad-frm">  
                                ...
                                <div class="form-group image-input uploaded-img-section original_file_display " style="display:none;">
                                    <label>Image</label>
                                    <div class="clearfix"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="start_date" name="start_date" placeholder="Select Pickup Date" type='text' class="form-control datepicker" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="end_date" name="end_date" placeholder="Select End Date " type='text' class="form-control datepicker" />
                                        </div>
                                    </div>
                                </div>
...
<div class="steps-sticky-section">
    ...
    <script>
        ...
        $(document).on("change", ".file_multi_video", function(evt) {
            ...
            jQuery('.original_file_display').show();
            jQuery("#original_file_display").attr("src",$source[0].src);  
        });
