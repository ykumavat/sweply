...
<script>
    ...
    $(document).ready(function(){        
       ...
       $('#end_date').change(function(){
            ...
            if(endDay<startDay){
                $('#end_date').parent().append('<br/><label class="err-msg">End date should be greater than start date </label>');
            }else{
                $('#end_date').parents().find('.err-msg').remove();
            }
       });
    ...
    $(function() {
        ...
        $('#campaign_budget').on("keyup change blur",function(){
            ...
            $('.service_amount').text(service_charges);
