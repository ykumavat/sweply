                            ...
                            <div class="creadte-ad-frm">  
                                ...
                                <div class="form-group image-media">
                                    <div class="radio-btns campaign-radio-section">
                                        ...
                                        <div class="radio-btn"  id="addMultiImages">
            ...
            if(fileSize<5242880){
                ...
                setTimeout(function(){ 
                    ...
                    if(parseInt(width)<1200){
                        ...
                        if(widthArr.indexOf(parseInt(height))<0 && (parseInt(height)<600) || (parseInt(height)<800)  || (parseInt(height)<1200) ){
                            $('.image-media').append('<label class="err-msg">Required image size : "1200 x 600px" Or "1200 x 800px" Or "1200 x 800px" </label>');
                        }else{
            ...
            if(uploadedSlides<6){
                ...
                for(let index = 0; index < inputFile[0].files.length; index++) {
                  ...
                  reader.onload = function (e) {
                    ...
                    var imageSrc = '<div class="uploaded-img-main"><div class="uploaded-img"><img src="'+e.target.result+'" alt="" /></div><span class="close-img"  onclick="removeImage('+uniqid+')"  rel="'+uniqid+'" >×</span></div>';
                    $('#previewImg').append(imageSrc);

                    var imageSliderSrc = '<div class="swiper-slide" rel="'+uniqid+'"><img src="'+e.target.result+'" alt="" /></div>';
