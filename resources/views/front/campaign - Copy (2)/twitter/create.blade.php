                                ...
                                <div class="form-group image-media">
                                    <div class="radio-btns campaign-radio-section">
                                        ...
                                        <div class="radio-btn addMultiImages"  id="addMultiImages">
                                            <p class="image-dimesion" style="display:none;"></p>
...
<!---------------------JUGAD------------------->
  <script type="text/javascript">
    var filesArr = [];
    $(document).ready(function(){
        filesArr = multiImageCarousel();
        if(filesArr.length === 0){
            filesArr = multiVideoUpload();
        }
    });
                        ...
                        if (input.files && input.files[0]) {
                            ...
                            reader.onload = function (e) {
                                if(parseInt(height)<=1200 && parseInt(width)<=1200){
                                    ...
                                    imageSrc = '<div class="uploaded-img-main"><div class="uploaded-img"><img src="'+e.target.result+'" alt="" /></div><span class="close-img"  onclick="removeImage('+uniqid+')"  rel="'+uniqid+'" >×</span></div>';
                                    $('#previewImg').append(imageSrc+' '+imageAddBtn);
                                     imageSliderSrc = '<div class="swiper-slide" rel="'+uniqid+'"><img src="'+e.target.result+'" alt="" /></div>';
