                        ...
                        <div class="from-tab-section">
                            ...
                            <div class="form-group">
                                <?php if(isset($userData->vat_cr_certificate) && $userData->vat_cr_certificate!="" ){ ?>
                                    <label><a style="width:100%;" href="<?php echo url('/').'/uploads/user_image/'.$userData->vat_cr_certificate; ?>"  class="uploaded-img-download"  download><i class="fal fa-download"> &nbsp;Download/View certificate </i></a></label>
                                <?php } ?>
                            </div>
                        </div>
                        </div>
