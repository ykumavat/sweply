            ...
            <div class="main-menu-content">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    <li class=" nav-item"><a href="{{url('/')}}/admin/dashboard/"><i class="fal fa-tachometer-alt-fast"></i><span class="menu-title" data-i18n="Email">Dashboard</span></a></li>
                     <li class=" nav-item"><a href="staff"><i class="fal fa-tachometer-alt-fast"></i><span class="menu-title" data-i18n="Email">Staff</span></a></li>
                    ...
                    <li class=" nav-item"><a href="campaign"><i class="fal fa-bullhorn"></i><span class="menu-title" >Campaigns</span></a></li>
