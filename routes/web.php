...
Route::group(array('prefix' => '/','middleware' => ['web']), function(){
	...
	//Route::get('set-locale',	['as' => $route_slug.'change_language',	'uses' => $module_controller.'change_language']);
