...
class CampaignController extends Controller{
    ...
    function store_campaign_data(Request $request){
		...
		{	
			...
			if(in_array($file_extension,['png','jpg','jpeg','mp4','mov']))
			{
        ...
        /*** Screen Shot Store Start here ***/
        /*
        $arr_data['app_icon']        = $request->input('app_icon',null);
        $arr_data['contact_number']  = $request->input('contact_number',null);
        $arr_data['text_msg']        = $request->input('text_msg',null);
        $arr_data['contact_method']  = $request->input('contact_method',null);
        */
